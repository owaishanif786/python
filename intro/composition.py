...
class Tire:
    """
    Trie represents a tire that would be used with an automobile.
    """
    ...
    def __repr__(self):
        """
        Represent the tire's information in the standard notation present on the side of thetire. Example: 'P215/65R15'
        """
